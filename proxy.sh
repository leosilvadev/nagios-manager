...
#HTTP_PROXY_HOST=proxy.gsw.com.br
#HTTP_PROXY_PORT=3128

HTTPS_PROXY_HOST=lnx237in.sjk.emb
HTTPS_PROXY_PORT=9090
#HTTPS_PROXY_HOST=proxy.gsw.com.br
...
function proxy_gnome
{
	...
	gsettings set org.gnome.system.proxy ignore-hosts "['localhost', '127.0.0.0/8', '::1', '*.sjk.emb', '10.5.2.*']" 
}
